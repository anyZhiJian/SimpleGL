...
inline static void sgl_draw_original_hline(sgl_t *sgl, int x, int y, int len, uint32_t color)
{
    int i;
    int x1 = x + len;
    if (len > 0)
...
inline static void sgl_draw_original_vline(sgl_t *sgl, int x, int y, int len, uint32_t color)
{
    int i;
    int y1 = y + len;
    if (len > 0)
